...
public class Parent implements Visitor {
    ...
    public void visit(Student student) {
        System.out.println("student name: " + student.name + ",class: " + student.clazz + ",rank: " + student.ranking());
    }

    @Override
    public void visit(Teacher teacher) {
        System.out.println("teacher name: " + teacher.name + ",entrance rate: " + teacher.entranceRatio() + "teacher level" + teacher.identity);
    }
}
