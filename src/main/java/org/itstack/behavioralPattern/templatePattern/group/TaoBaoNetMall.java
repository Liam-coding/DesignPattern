...
public class TaoBaoNetMall extends NetMall {
    ...
    protected Boolean login(String uId, String uPwd) {
        System.out.println("TaoBao login...uid"+uId+" upwd"+uPwd);
        return true;
    }
    ...
    protected Map<String, String> reptile(String skuUrl) {
        ...
        System.out.println("TaoBao reptile analyzing, price"+map.get("name")+",price:"+map.get("price"));
        return map;
    }
    ...
    protected String createBase64(Map<String, String> goodsInfo) {
        ...
        System.out.println("mock TaoBao generate base64 poster");
